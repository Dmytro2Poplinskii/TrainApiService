...
class UserSerializerTest(TestCase):
    ...
    def test_update_user(self):
        user = get_user_model().objects.create(username='test_user', email='test@example.com', password='testpassword')
...
class UserViewSetTestCase(APITestCase):
    ...
    def test_create_user(self):
        self.client.credentials(HTTP_AUTHORIZATION='Token ' + self.token_admin.key)
        data = {'username': 'new_user', 'email': 'new@example.com', 'password': 'newpassword'}
...
class ManageUserViewTestCase(APITestCase):
    ...
    def test_update_user(self):
        self.client.credentials(HTTP_AUTHORIZATION='Token ' + self.token.key)
        data = {'email': 'updated@example.com', 'password': '<PASSWORD>', "username": "updated_user"}
